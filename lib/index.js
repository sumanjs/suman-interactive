...
exports.start = function () {
  ...
  _suman._interactiveDebug(' => beginning of interactive session => ');
...
//////////////////////////////////////////////////////
  ...
  const _cwd = path.resolve(process.env.HOME + '/.suman/global');
  ...
  async.parallel({
    ...
    const firstSetOfQuestions = [
...

      {
        ...
        default: 0,
        onLeftKey: function () {
          _suman._interactiveDebug('left key fired in top level!');
    ...
    const secondSetOfQuestions = [
      {
        ...
        message: 'What would you like to do?',
        onLeftKey: function () {
          _suman._interactiveDebug('left key fired in generate list!');
          _suman.onBackspace(start);
        },
        default: 0,
    ...
    function generateList(obj, onBackspace) {
      ...
      _suman._interactiveDebug('ITEMS => ', items);
    ...
    function start() {
      ...
      _suman._interactiveDebug('readable count:', process.stdin.listenerCount('readable'));
      _suman._interactiveDebug('keypress count:', process.stdin.listenerCount('keypress'));
      _suman._interactiveDebug('keypress count:', process.stdin.listenerCount('keypress'));
